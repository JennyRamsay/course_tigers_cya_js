...
In this lab you will be using the testing framework, Jest, to design, build and test the game logic for a two-player game of Superheroes Top Trumps. Your task is to build a game of Top Trumps with the following features:
...
- Install mocha as a dev dependency with `npm install -D jest`
- Update the test script in the package.json to use jest
